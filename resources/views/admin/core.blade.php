...
<head>
  ...
  <title>Store Front Inventory Management Admin - Dashboard</title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="{{route('admin.home')}}">Store Front</a>
      ...
      <li class="nav-item dropdown">
       ...
       <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="{{route('admin.createUser')}}">New User</a>
            <a class="dropdown-item" href="{{route('admin.allUser')}}">Manage Users</a>
      </li>
